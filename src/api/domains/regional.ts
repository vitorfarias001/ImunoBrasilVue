...
export default {
  async pesquisar(params?: IRegionalSearchData) {
    try {
  ...
  async pesquisarArray(params?: IRegionalSearchArrayData) {
    try {
  ...
  async salvar(data: IRegionalData) {
    try {
  ...
  async atualizar(data: IRegionalData, id: string | number) {
    try {
